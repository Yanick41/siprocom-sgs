 ...
 *
 * Three things keep it from being a backdoor:
 *
 ...
 *   2. The secret is compared in constant time, and travels in a header rather
 *      than the URL so it stays out of access logs and browser history.
 *   3. It is rate limited on the same buckets as login, and every use is
